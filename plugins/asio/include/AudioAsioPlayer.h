...
#ifndef SSI_ASIO_AUDIOASIOPLAYER_H
#define SSI_SENSOR_AUDIOASIOPLAYER_H

#include "base/IConsumer.h"
#include "sensor/audio/AudioOut.h"
...
class AudioAsioPlayer : public IConsumer {
...
public:
	...
	static const ssi_char_t *GetCreateName () { return "ssi_consumer_AudioAsioPlayer"; };
	static IObject *Create (const ssi_char_t *file) { return new AudioAsioPlayer (file); };
	~AudioAsioPlayer ();

	AudioAsioPlayer::Options *getOptions () { return &_options; };
...
protected:
	...
	AudioAsioPlayer (const ssi_char_t *file = 0);
	AudioAsioPlayer::Options _options;
	ssi_char_t *_file;	
