...
ssi_char_t *AudioAsioPlayer::ssi_log_name = "audioasiop";

AudioAsioPlayer::AudioAsioPlayer (const ssi_char_t *file)
	:  _file (0) {
...
AudioAsioPlayer::~AudioAsioPlayer () {
...
void AudioAsioPlayer::consume_enter (ssi_size_t stream_in_num,
    ...
    _format = ssi_create_wfx (ssi_cast (unsigned int, stream_in[0].sr),
		...
		ssi_cast (unsigned short, (_scaled ? sizeof (short) : sizeof (float))));
...
void AudioAsioPlayer::consume (IConsumer::info consume_info,
...
void AudioAsioPlayer::consume_flush (ssi_size_t stream_in_num,
	ssi_stream_t stream_in[]) {
...
int AudioAsioPlayer::selectDevice () {
...
int AudioAsioPlayer::getDevice (const ssi_char_t *name) {
...
unsigned int AudioAsioPlayer::numDevicesForApi(int api_type)
{
	PaDeviceIndex n_devices = Pa_GetDeviceCount();
	const PaDeviceInfo *device;
...
int AudioAsioPlayer::LetUserSelectDevice (StringList &list) {
...
int AudioAsioPlayer::LetUserSelectDeviceOnConsole(StringList &list) {
