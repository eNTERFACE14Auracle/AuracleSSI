...
namespace XMLReader {
	...
	public: System::Collections::Generic::List<String^>^ ReadDll(String^ path);
	public: MetaData^ ReadMetaData(String^ name);
	private: void ReadChannelData(ssi::ISensor& sensor, SensorMetaData^ data);
	};
