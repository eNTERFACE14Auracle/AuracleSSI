...
namespace SSIXmlEditor.Controller
{
    class SSIModulesController
    {
        ...
        public SSIModulesController(App.Application app, Model.ISSIModules model, View.ISSIModulesView view)
        {
            if (null == app)
            ...
            m_View.SSIModuleActivated += new EventHandler<SSIXmlEditor.View.SSIModuleEventArgs>(m_View_SSIModuleActivated);
            m_View.SSIModuleSelected += new EventHandler<SSIXmlEditor.View.SSIModuleEventArgs>(m_View_SSIModuleSelected);
        ...
        void m_View_SSIModuleSelected(object sender, SSIXmlEditor.View.SSIModuleEventArgs e)
        {
            m_Model.Select(e.SSIModule.Name);
        }

        void m_View_SSIModuleActivated(object sender, SSIXmlEditor.View.SSIModuleEventArgs e)
        {
