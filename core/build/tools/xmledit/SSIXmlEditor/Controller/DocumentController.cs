...
namespace SSIXmlEditor.Controller
{
    public class DocumentController
    {
        ...
        public DocumentController(Document.ADocument document, View.IDocumentView view)
        {
            ...
            Document.StateChanged += new EventHandler<SSIXmlEditor.Document.DocumentStateChangedEventArg>(Document_StateChanged);
        }

        void Document_StateChanged(object sender, SSIXmlEditor.Document.DocumentStateChangedEventArg e)
        {
