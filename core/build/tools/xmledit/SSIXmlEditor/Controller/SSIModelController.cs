...
namespace SSIXmlEditor.Controller
{
    public class SSIModelController
    {
        ...
        public SSIModelController(Model.SSIModel model, View.ISSIModelView view)
        {
            ...
            m_View.ModelChanged += new EventHandler<SSIXmlEditor.View.SSIModelChangedEventArgs>(m_View_ModelChanged);
            
        }

        void m_View_ModelChanged(object sender, SSIXmlEditor.View.SSIModelChangedEventArgs e)
        {
			m_Model.Change(e);
        }
