...
namespace SSIXmlEditor.InputHandler
{
    class KeyWordDetector 
    {
        ...
        {
            m_Filter = new SSIXmlEditor.Filter.KeyWordFilter(new string[] { "ssi_sensor_Audio" }) { FilterStrategy = new Filter.Strategy.XmlAttributeFilterStrategy("create") };
            m_Filter.Found += new EventHandler<SSIXmlEditor.Filter.KeyWordFilterEventArgs>(m_Filter_Found);
        ...
        void m_Filter_Found(object sender, SSIXmlEditor.Filter.KeyWordFilterEventArgs e)
        {
