...
namespace SSIXmlEditor.Controls
{
	public class EditorTabPage : TabPage, View.IDocumentView, Model.IInputHandler
	{
        ...
        public EditorTabPage(Document.ADocument document)
        {
            ...
            m_Controller = new SSIXmlEditor.Controller.DocumentController(document, this);
        ...
        private SSIXmlEditor.Snippets.SnippetManager m_Snippets = SSIXmlEditor.Snippets.SnippetManager.Instance;
