...
namespace SSIXmlEditor
{
    ...
    {
        private App.Application m_Application;
        ...
        public event EventHandler<SSIXmlEditor.View.SSIModuleEventArgs> SSIModuleSelected;
        public event EventHandler<SSIXmlEditor.View.SSIModuleEventArgs> SSIModuleActivated;
        ...
        public event EventHandler<SSIXmlEditor.View.SSIModelChangedEventArgs> ModelChanged;

        #endregion

        public static PropertyGrid Prop { get; set; }

        public MainForm(App.Application app)
        {
            if (null == app)
            ...
            m_DocumentsView = new Controls.DocumentControl(app) { Dock = DockStyle.Fill };
        ...
        private void Init()
        {   
            m_SSIModulesController = new SSIXmlEditor.Controller.SSIModulesController(m_Application, m_Application.GetModel<Model.ISSIModules>(), this);
            m_SSIModuleController = new SSIXmlEditor.Controller.SSIModelController(m_Application.GetModel<Model.SSIModel>(), this);
        ...
        void propertyGrid1_PropertyValueChanged(object s, PropertyValueChangedEventArgs e)
        {
            ...
            if (null != ModelChanged)
                ModelChanged(this, new SSIXmlEditor.View.SSIModelChangedEventArgs(item, e.ChangedItem.Parent.Label, e.ChangedItem.Label, e.ChangedItem.Value, e.OldValue));
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            m_Controller = new SSIXmlEditor.Controller.MainController(m_Application, this);
            Init();
        }
        ...
        private void FireModuleSelectedEvent(MetaData selected)
        {
            if (null != SSIModuleSelected)
                SSIModuleSelected(this, new SSIXmlEditor.View.SSIModuleEventArgs(selected));
        }

        private void FireModuleActivatedEvent(MetaData selected)
        {
            if (null != SSIModuleActivated)
                SSIModuleActivated(this, new SSIXmlEditor.View.SSIModuleEventArgs(selected));
        }
		...
		private void graphicalToolStripMenuItem_Click(object sender, EventArgs e)
		{
			...
			var graph = new SSIXmlEditor.View.GraphicalView(m_Application.ModelRepository);
			graph.ShowDialog(); 
		}
	}
}
