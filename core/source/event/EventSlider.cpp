...
bool EventSlider::setEventListener (IEventListener *listener) {
	...
	_slider = new Slider (name, _options.pos[0], _options.pos[1], _options.pos[2], _options.pos[3], _options.defval, _options.minval, _options.maxval, _options.steps);
