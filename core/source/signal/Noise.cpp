...
void Noise::transform (ITransformer::info info,
	...
	SignalTools::Noise (stream_out, _options.ampl, _options.mean, _options.stdv, (_options.norm ? _options.cutoff * (stream_in.sr / 2) : _options.cutoff), (_options.norm ? _options.width * (stream_in.sr / 2) : _options.width)); 
}
