...
#include "sensor/camera/CameraQualityProps.h"
#include "sensor/camera/CameraTools.h"
#include "sensor/camera/CameraList.h"
#include "sensor/camera/VideoTypeInfoList.h"
...
HRESULT Camera::GetCurrentSampleInStream (BYTE *sampleData, int *sampleBufferSize, bool flip)
{
	HRESULT hr = E_ABORT;
