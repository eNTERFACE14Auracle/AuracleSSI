...
public:
	...
	bool setHotClass (ssi_size_t hot_id);
	bool setHotClass (ssi_size_t n_hotties, ssi_size_t *hotties, const ssi_char_t *hot_name);
	...
	const ssi_char_t *getClassName (ssi_size_t class_id) { return class_id == 0 ? _hot_name : SSI_ISAMPLES_REST_CLASS_NAME; };
