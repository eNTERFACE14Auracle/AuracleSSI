...
#include "sensor/camera/CameraCons.h"
...
public:
	...
	public:
		...
		Options ()
			: mouse (false), mouse_size (4), fps (25.0), resize (false), resize_width (0), resize_height (0), resize_method (1) {
...
public:
	...
	static const ssi_char_t *GetCreateName () { return "ssi_sensor_CameraScreen"; };
...
protected:
	...
	IProvider *_provider;
	BYTE *_buffer, *_org_buffer, *_rsz_buffer;
