...
#include "sensor/camera/CameraOptions.h"
...
public:
	...
	static const ssi_char_t *GetCreateName () { return "ssi_sensor_Camera"; };
	...
	virtual HRESULT GetCurrentSampleInStream (BYTE *sampleData, int *sampleBufferSize, bool flip);
