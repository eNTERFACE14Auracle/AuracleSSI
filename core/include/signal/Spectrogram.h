...
public:
	...
	ssi_size_t Spectrogram::getSampleDimensionOut (ssi_size_t sample_dimension_in) {
	...
	ssi_size_t Spectrogram::getSampleBytesOut (ssi_size_t sample_bytes_in) {
		return sizeof (ssi_real_t);
	}
	ssi_type_t Spectrogram::getSampleTypeOut (ssi_type_t sample_type_in) {
