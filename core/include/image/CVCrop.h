...
public:
	...
	public:
		...
		Options () : width (100), height (100), method (METHOD::LINEAR), origin (ORIGIN::LEFTTOP), scaled (true), flip (false), keep (false) {
...
public:
	...
	static const ssi_char_t *GetCreateName () { return "ssi_filter_CVCrop"; };
